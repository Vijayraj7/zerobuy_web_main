...
use App\Http\Requests\BusinessShopCategoryRequest;
...
class BusinessCategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return $this->json('categories', [
            'total' => $total,
            'selected_categories' => BusinessCategoryResource::collection($shop->businessCategories),
            'categories' => BusinessCategoryResource::collection($categories),
        ]);
    }

    public function shopstore(BusinessShopCategoryRequest $request)
    {
        $shop = generaleSetting('shop');
