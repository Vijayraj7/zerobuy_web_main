    ...
    <div class="page-title-wrapper">
        <div class="w-100 page-title-heading d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2 align-items-center gap-md-4"> 
                ...
                <a href="{{route('admin.advertisement.transactions')}}" class="btn py-2 btn-warning"> <i class="fa fa-exchange"></i> {{__('Transaction History')}} </a> 
    ...
    <script>
        $(function () {
            ...
            function loadProducts(q = '') {
                $.get("{{ route('admin.advertisement.products') }}", { q }, function (data) {
                    let rows = '';
                    data.forEach(p => {
                        rows += `
                        <tr>
