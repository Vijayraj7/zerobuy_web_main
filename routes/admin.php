...
Route::name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'checkPermission'])->group(function () {
        ...
        Route::controller(BusinessCategoryController::class)->group(function () {
            ...
            Route::delete('/business-category/{businessCategory}/destroy', 'destroy')->name('business-category.destroy');
        ...
        Route::controller(SubscriptionPlanController::class)->group(function () {
            ...
            // CREATE
            Route::get('/subscription-plan/create', 'create')->name('subscription-plan.subscription.create');

            // STORE
            Route::post('/subscription-plan/store', 'store')->name('subscription-plan.subscription.store');

            // EDIT
            Route::get('/subscription-plan/{subscriptionPlan}/edit', 'edit')->name('subscription-plan.subscription.edit');

            // UPDATE
            Route::put('/subscription-plan/{subscriptionPlan}/update', 'update')->name('subscription-plan.subscription.update');

            // DELETE
            Route::delete('/subscription-plan/{subscriptionPlan}/destroy', 'destroy')->name('subscription-plan.subscription.destroy');
