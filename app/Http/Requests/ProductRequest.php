...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'variants.*.weight'   => 'required_with:variants|integer|min:1',
            ...
            'bulk_items.*.weight'        => 'required_with:bulk_items|integer|min:1',
            'bulk_items.*.length'        => 'nullable|numeric|min:0',
            'bulk_items.*.width'         => 'nullable|numeric|min:0',
            'bulk_items.*.height'        => 'nullable|numeric|min:0',
