            ...
            <div class="app-header-content">
                ...
                <div class="app-header-left">
                    ...
                    <div class="header-text">
                        <h4 class="mb-0 header-title">@yield('header-title')</h4>
                        <p class="mb-0 header-subtitle">@yield('header-subtitle')</p>
                    </div>
                </div>
                    ...
                    <div class="user-profile-box user-profile dropdown">
                        <div class="nav-profile-box dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="profile-image">
                                <img class="profilePic" src="{{ auth()->user()?->thumbnail ?? asset('assets/icons/user.svg') }}" alt="profile" loading="lazy" />
                            </div>
                        </div>

                        <div class="dropdown-menu profile-item">
                            <div class="d-flex justify-content-start p-2">
                                <img src="{{ auth()->user()?->thumbnail ?? asset('assets/icons/user.svg') }}" class="profilePic" alt="profile" loading="lazy">
                                <div class="ms-1">
                                    <span class="name pb-1">{{ auth()->user()?->name }}</span>
                                    <p class="pb-2 text-muted" style="font-size:12px ">{{ auth()->user()?->email }}</p>
                            ...
                            @if (request()->is('admin/*', 'admin'))
                                @hasPermission('admin.profile.index')
                                    ...
                                    <a href="{{ route('admin.profile.index') }}" class="dropdown-item">
                                        <img src="{{ asset('assets/icons-admin/user-circle.svg') }}" alt="user" loading="lazy" /> {{ __('Profile') }}
                                    </a>
                                @endhasPermission
                            @else
                            ...
                            @if (request()->is('admin/*', 'admin'))
                                @hasPermission('admin.generale-setting.index')
                                    ...
                                    <a href="{{ route('admin.generale-setting.index') }}" class="dropdown-item">
                                        <img src="{{ asset('assets/icons-admin/settings.svg') }}" alt="setting" loading="lazy" /> {{ __('Settings') }}
                                    </a>
                                @endhasPermission
                                @hasPermission('admin.profile.change-password')
                                    <hr class="dropdown-profile-divider">
                                    <a href="{{ route('admin.profile.change-password') }}" class="dropdown-item">
                                        <img src="{{ asset('assets/icons-admin/role-permission.svg') }}" alt="key" loading="lazy" /> {{ __('Change Password') }}
                                    </a>
                                @endhasPermission
                            @else
                ...
                <div class="app-main-inner">
                    <div class="container-fluid">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show mb-3 w-100 text-center rounded-0 text-black"
                            ...
                            <strong><i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="bottom" title='If you do not run this seeder, you will not be able to use the system.'></i>
                                Seeder dose not run.</strong> Please run <code class="text-danger">php artisan migrate:fresh --seed</code> or <a href="{{ route('seeder.run.index') }}"
